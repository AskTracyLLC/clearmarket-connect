...
DROP TRIGGER IF EXISTS auto_generate_field_rep_username ON public.field_rep_signups;
DROP TRIGGER IF EXISTS auto_generate_vendor_username ON public.vendor_signups;

-- Drop existing function if it exists
DROP FUNCTION IF EXISTS public.auto_generate_signup_username();
