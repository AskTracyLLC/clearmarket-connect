...
-- Migrate existing data for field reps (only using existing columns)
INSERT INTO public.field_rep_signups (
  email, primary_state, anonymous_username, feedback_access_token, 
  feedback_token_expires_at, join_feedback_group, created_at, updated_at
)
SELECT 
  email, primary_state, anonymous_username, feedback_access_token,
  feedback_token_expires_at, join_feedback_group, created_at, updated_at
...
-- Migrate existing data for vendors (only using existing columns)
INSERT INTO public.vendor_signups (
  email, company_name, company_website, states_covered, anonymous_username,
